...
if [ $condition -eq 0 ] ; then
    ...
    mkdir /home/rover/sketchbook
    mkdir /home/rover/sketchbook/libraries
else
...
if [ $condition -eq 0 ]; then
    ...
    cd /home/rover
    rm -f /home/rover/master.zip
    rm -R -f /home/rover/avrdude-rpi-master
...
if grep -q 'shutdowncheck.py' /etc/rc.local; then
    ...
    mkdir -p /home/rover/bin/SleepyPi
    wget https://raw.githubusercontent.com/SpellFoundry/Sleepy-Pi-Setup/master/shutdowncheck.py
    mv -f shutdowncheck.py /home/rover/bin/SleepyPi
    sed -i '/exit 0/i python /home/rover/bin/SleepyPi/shutdowncheck.py &' /etc/rc.local
    # echo "python /home/rover/bin/SleepyPi/shutdowncheck.py &" | sudo tee -a /etc/rc.local
fi
