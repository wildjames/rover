...
cp hardware_controller.service /etc/systemd/system/
systemctl enable hardware_controller.service
echo "Starting rover controller service"
systemctl start hardware_controller.service
echo "Is the rover controller service running?"
systemctl is-active hardware_controller.service
